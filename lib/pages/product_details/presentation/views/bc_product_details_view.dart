  ...
  Widget build(BuildContext context) {
    return Scaffold(
        appBar: AppBarItem(
          ...
          title: CustomText("${AppStrings.numberOfProduct} ${(controller.productDetailsModel?.data?.items?.isEmpty??true) ?"" : (controller.productDetailsModel?.data?.items?[0].partNumber??"" ) }",
        ...
        body: controller.obx((state) => SingleChildScrollView(
          child: Column(
            ...
            children: [
              titleValue(AppStrings.productNumber, "${(controller.productDetailsModel?.data?.items?.isEmpty ??true)? "":controller.productDetailsModel?.data?.items?[0].partNumber ??""} "),
              const Divider(
                height: 2,
              ...
              titleValue(AppStrings.productName,(controller.productDetailsModel?.data?.items?.isEmpty ??true)? "":controller.productDetailsModel?.data?.items?[0].name ??""),
              const Divider(
                height: 2,
                color: Color(ColorCode.secondryblueGray),
              ),
              if (controller
                ...
                children: [
                  Expanded(
                      child: titleValue(AppStrings.purchasePrice, "${(controller.productDetailsModel?.data?.items?.isEmpty ??true)? "":controller.productDetailsModel?.data?.items?[0].purchasePrice ??0} ${AppStrings.rs}")),
                  const VerticalDivider(
                    width: 1,
                    color: Color(ColorCode.secondryblueGray),
                  ),
                  Expanded(
                    child: titleValue(AppStrings.price,  "${(controller.productDetailsModel?.data?.items?.isEmpty ??true)? "":controller.productDetailsModel?.data?.items?[0].price ??0} ${AppStrings.rs}"),
                  )
                ],
              ),
              // const Divider(
              ...
              //   color: Color(ColorCode.secondryblueGray),
              // ),
              // titleValue(AppStrings.amount, "${(controller.productDetailsModel?.data?.items?.isEmpty ??true)? "":controller.productDetailsModel?.data?.items?[0].addedStock ??0} "),
              //
              // const Divider(
              //   height: 2,
              //   color: Color(ColorCode.secondryblueGray),
              // ),
              // titleValue(AppStrings.stock, "${(controller.productDetailsModel?.data?.items?.isEmpty ??true)? "":(controller.productDetailsModel?.data?.items?[0].addedStock  ??0) +(controller.productDetailsModel?.data?.items?[0].oldStock  ??0)} "),
              //
              // const Divider(
              //   height: 2,
              //   color: Color(ColorCode.secondryblueGray),
              // ),
              // titleValue(AppStrings.inventoryValue, "${(controller.productDetailsModel?.data?.items?.isEmpty ??true)? "":controller.productDetailsModel?.data?.items?[0].currentStockPrice ??0} "),
              //
              // const Divider(
              //   height: 2,
              //   color: Color(ColorCode.secondryblueGray),
